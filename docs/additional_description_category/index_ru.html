...
<head>
	...
	<title>Additional Description Category v1 - Документация</title>
...
<div id="container">
	<div class="rd-mobilepanel fixed">
		<div class="logo">
			<h1 class="rd-mobilepanel_title pull-left"><a type="button" id="button-menu" class="pull-left"><i class="fa fa-dedent fa-lg"></i></a><span>Additional Description Category</span> Документация</h1>
			<div class="rd-mobilepanel_titler pull-right">
				<span>Создан: 13/11/2017</span>
				<span>Последнее обновление: 13/11/2017</span>
				<span>Версия 1</span>
			</div>
				...
				<div class="tab-content">
					<section class="tab-pane active" id="home" >
						<article class="description">
							<h2>Введение</h2>
							<p>Данный модификатор поможет вам добавить текст, баннер или HTML-код в нижней части страниц категорий, который будет отличаться от описания категорий по-умолчанию.</p>	
							<ul>
								<li>Модификатор добавляет дополнительное текстовое поле в Админ-панели при добавлении новой категории или редактировании существующей;</li>
								<li>Имеет визуальный редактор HTML, так что вы можете использовать HTML теги для SEO;</li>
								<li>Дополнительное описание будет отображаться в нижней части списка продуктов;</li>
								<li>Мультиязычный;</li>
								<li>Для мобильных/планшетных устройств дополнительное описание скрыто, но при этом имеет кнопку «Показать описание / Скрыть описание»;</li>
								<li>Имеет функцию скрывать описание и дополнительное описание со 2+ страниц категорий;</li>
								<li>Для стандартного описания и для дополнительного описания есть возможность скрыть длинное описание с появление кнопки «Развернуть/Свернуть»;</li>
								<li>Настройки стандартного описания и дополнительного описания для каждого пункта категории.</li>
							</ul>
						</article>
					</section>
					...
					<section class="tab-pane" id="install">
						<article class="description">
							<h2>Установка</h2>
							<p>Установка модификатора состоит из двух частей. В каждой папке <strong>«Opencart v2.x»</strong> вы обнаружите две папки: <strong>«Step-1-Administration»</strong> и <strong>«Step-2-Templates»</strong>.</p>
							<ol>						
								<li>В папке <strong>«Step-1-Administration»</strong> найдете архив <strong class="red">«extra_description_category_backend.ocmod.zip»</strong> в котором содержится основной функционал, локализация и скрипты.</li>
								<li>В папке <strong>«Step-2-Templates»</strong> найдете список модификаторов для своего шаблона. Список постепенно будет пополняться для популярных шаблонов.</li>
							</ol>
							<br>
							<hr>				
							<h3>Шаг 1</h3>
							<ol>						
								<li>В админке перейдите <strong class="blue">«Модули > Установка расширений»</strong> и установите файл <strong class="red">«extra_description_category_backend.ocmod.zip»</strong>;</li>
								<li>Получаем сообщение об успешной установке и идем в <strong class="blue">«Модули > Модификаторы»</strong> и кликаем по кнопке <strong class="blue">«Обновить»</strong> в правом верхнем углу <a href="/images/edc/admin_mod_ru.jpg">См. пример</a>;</li>
							...
							<hr>
							<h3>Шаг 2</h3>
							<p>Выберите нужный модификатор из папки <strong>«Step-2-Templates»</strong> и выполните следующие действия:</p>
							<ol>
								<li>В админке перейдите <strong class="blue">«Модули > Установка расширений»</strong> и установите файл <strong class="red">«extra_description_category_frontend.ocmod.xml»</strong> для вашего шаблона;</li>
								<li>Получаем сообщение об успешной установке и идем в <strong class="blue">«Модули > Модификаторы»</strong> и кликаем по кнопке <strong class="blue">«Обновить»</strong> в правом верхнем углу <a href="/images/edc/admin_mod_ru.jpg">См. пример</a>;</li>
					...
					<section class="tab-pane" id="setting">
						<article class="description">
							...
							<div class="box-img"><img src="/images/edc/settings_admin_ru.jpg"></div>
						</article>
					</section>
					<section class="tab-pane" id="design">
						<article class="description">
							<h2>Внешний вид</h2>
							<p>Если стандартный дизайн не вписывается в ваш дизайн сайта, вы можете подправить CSS стили в файле <strong class="blue">«readmore.css»</strong>, который находится:<p>
					...
					<section class="tab-pane" id="language">
						<article class="description">
							...
							<h3>Админ-панель:</h3> 
							<ul>
								<li>Скопируйте файл <strong class="red">«extra_category_description.php»</strong> из папки:<p class="alert alert-info">admin \ language \ russian \ catalog \ extra_category_description.php</p>
								</li>
								<li>Вставьте в папку и после чего переведите содержимое файла:
								<p class="alert alert-info">admin \ language \ ВАШ_ЯЗЫК \ catalog \ extra_category_description.php</p></li>
							</ul>
							<br>
							<hr>
							<h3>Магазин:</h3> 
							<ul>
								<li>Скопируйте файл <strong class="red">«extra category description.php»</strong> из папки: <p class="alert alert-info">catalog \ language \ russian \ product \ extra_category_description.php</p></li>
								<li>Вставьте в папку и после чего переведите содержимое файла:<p class="alert alert-info">catalog \ language \ ВАШ_ЯЗЫК \ product \ extra_category_description.php</p></li>
							</ul>
						</article>
					</section>
							...
							<ul class="list-unstyled timeline">
								...
								<li>
									<div class="block">
										...
										<div class="block_content">
											<ul class="excerpt">
												<li>Объединение v3.1 и v3.2.1 в единую версию;</li>
												<li>Оптимизирован код для работы на сборках Opencart / Opencart.pro / ocStore;</li>
												<li>Работает с версии 2.0.1.0 и выше;</li>
												<li>Модификатор разделен на BackEnd и FrontEnd;</li>
												<li>Языковая локализация вынесена в отдельный файл;</li>				
												<li>Обновлен <a href="https://github.com/jedfoster/Readmore.js" title="Github плагина">Readmore.js до v2.2.0</a>;</li>
												<li>Поддержка шаблона XDS Coloring Theme v1.3.7.2 / v1.6.1;</li>
									...
									<div class="block">
										...
										<div class="block_content">
											<ul class="excerpt">
												...
												<li>Добавлена поддержка 2.3.0.x;</li>
												<li>Языковая локализация вынесена в отдельный файл.</li>
											</ul>
										</div>
									</div>
								...
								<li>
									<div class="block">
										...
										<div class="block_content">
											<ul class="excerpt">
												<li>Версия для OpenCart 2.2.0.0</li>
											</ul>
										</div>
									</div>
								</li>
								<li>
									<div class="block">
										...
										<div class="block_content">
											<ul class="excerpt">
												<li>Работа модификатора на сборке Opencart.pro;</li>
												<li>Работа модификатора на сборке ocStore;</li>
												<li>Разделитель «Развернуть/Свернуть» для описания и дополнительного описания;​</li>
												<li>Функция скрытия описания и изображения в категории со 2+ страниц;</li>
												<li>Настройка разделителя «Развернуть/Свернуть»;</li>
												<li>Добавлен css и js;</li>
												<li>Кнопка «Показать описание» для дополнительного описания в мобильной версии;​</li>
								...
								<li>
									<div class="block">
										...
										<div class="block_content">
											<ul class="excerpt">
												<li>Кнопка «Подробное описание» для мобильной / планшетной адаптации;​</li>
												<li>Функция скрытия описания категории со 2+ страниц;</li>
